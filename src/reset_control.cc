...
namespace franka_driver {
	...
	JointMotionGenerator::JointMotionGenerator(double speed_factor, const std::array<double, 7> q_goal)
	    : q_goal_(q_goal.data()) {
	...
	bool JointMotionGenerator::calculateDesiredValues(double t, Vector7d* delta_q_d) const {
	...
	franka::JointPositions JointMotionGenerator::operator()(const franka::RobotState& robot_state,
